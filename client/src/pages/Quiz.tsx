        ...
        >
          ...
          {currentStep.type === "timeline" && (
            <div className="space-y-6">
              ...
              <Suspense fallback={<div className="w-full bg-gradient-to-br from-card to-card/80 rounded-2xl p-6 border border-border shadow-lg mb-6 h-[280px] animate-pulse" />}>
                <ProgressChart landing={landing} />
              </Suspense>
